 ...
 * @author wolverine
 */
public class ImprimirVendaPrazo {
    ...
    public ImprimirVendaPrazo() {
    }
    
    

    public ImprimirVendaPrazo(Venda venda, String porta, Cliente cliente) {
        this.venda = venda;
        if (venda==null){
            JOptionPane.showMessageDialog(null, "Sem Venda");
        }
        valor =0;
        getListaSaida();
    ...
    private void imprimirTexto(){
        ...
        texto.append("\r\n");
        texto.append("\r\n");
        texto.append("Cliente : "   + String.valueOf(cliente.getIdcliente()) + " - " + cliente.getNome() + "\r\n");
        texto.append("\r\n");

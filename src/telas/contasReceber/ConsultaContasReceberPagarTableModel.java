 ...
 * @author Wolverine
 */
public class ConsultaContasReceberPagarTableModel extends AbstractTableModel{
    ...
    public ConsultaContasReceberPagarTableModel(List<ContasReceberBean> listaContasReceber) {
